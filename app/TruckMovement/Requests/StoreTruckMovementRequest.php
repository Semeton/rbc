...
class StoreTruckMovementRequest extends FormRequest
{
    /**
    ...
    public function messages(): array
    {
        return [
            ...
            'customer_cost.required' => 'Customer cost is required.',
            'customer_cost.numeric' => 'Customer cost must be a valid number.',
            'customer_cost.min' => 'Customer cost must be greater than or equal to 0.',
            ...
            'haulage.numeric' => 'Haulage must be a valid number.',
            'incentive.numeric' => 'Incentive must be a valid number.',
            'salary_contribution.numeric' => 'Salary contribution must be a valid number.',
            'salary_contribution.min' => 'Salary contribution must be greater than or equal to 0.',
