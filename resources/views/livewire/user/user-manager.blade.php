    ...
    <div class="mb-8">
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <div class="rounded-lg bg-white p-6 shadow border border-gray-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ $this->userStats['total'] }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-lg bg-white p-6 shadow border border-gray-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ $this->userStats['active'] }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-lg bg-white p-6 shadow border border-gray-200">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <flux:icon name="clock" class="h-8 w-8 text-orange-600" />
                    </div>
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-500">Inactive Users</p>
                        <p class="text-2xl font-semibold text-gray-900">{{ $this->userStats['inactive'] }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-lg bg-white p-6 shadow border border-gray-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ $this->userStats['suspended'] }}</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <flux:button variant="outline" size="sm" wire:click="deleteUser({{ $user->id }})" class="text-red-600 hover:text-red-800">
                                        Delete
                                    </flux:button>
                                </div>
                            </td>
