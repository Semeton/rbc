        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-zinc-900 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="mb-6">
                        <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Driver</h2>
                    ...
                    <form wire:submit="save" class="space-y-6">
                        ...
                        <flux:field>
                            ...
                            @elseif($driver->photo_url)
                                <div class="mt-2">
                                    <img src="{{ $driver->photo_url }}" alt="Current photo" class="h-20 w-20 rounded-full object-cover">
                        ...
                        <div class="flex justify-end space-x-3">
                            <flux:button variant="outline" href="{{ route('drivers.show', $driver) }}">
                                Cancel
                            </flux:button>
                            <flux:button variant="primary" type="submit" wire:loading.attr="disabled">
                                <span wire:loading.remove>Update Driver</span>
