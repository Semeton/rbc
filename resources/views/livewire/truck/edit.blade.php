        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="mb-6">
                        <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Truck</h2>
                        <p class="text-gray-600 dark:text-gray-400">Update truck information</p>
                    </div>
                    ...
                    <form wire:submit="save" class="space-y-6">
                        ...
                        <div class="flex justify-end space-x-3">
                            <flux:button variant="outline" href="{{ route('trucks.show', $truck) }}">
                                Cancel
                            </flux:button>
                            <flux:button variant="primary" type="submit" wire:loading.attr="disabled">
                                <span wire:loading.remove>Update Truck</span>
